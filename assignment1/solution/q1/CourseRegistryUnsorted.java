...
public class CourseRegistryUnsorted {
	...
	public CourseRegistryUnsorted(int capacity, int lab_num) {
	...
	public int search(int student, int lab_num) {
			for(int j=0; j<students[lab_num].length; j++){
				if(students[lab_num][j] == student)
					return j;
			}
		return -1;
	}
	...
	public static void main(String[] args) {
		...
		final int LAB = 5;
		CourseRegistryUnsorted comp2011_lab = new CourseRegistryUnsorted(CAPACITY, LAB);
